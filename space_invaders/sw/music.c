...
track_mapping_t tracks[NUM_TRACKS] = {
    {0,  MUSIC_MODE_MENU},
    {1,  MUSIC_MODE_SILENT},
    {2,  MUSIC_MODE_GAMEPLAY},
    {3, MUSIC_MODE_BOSS_INTRO},
    {4, MUSIC_MODE_BOSS},
    {5, MUSIC_MODE_BOSS_BLUE},
    {6, MUSIC_MODE_BOSS_YELLOW},
    {7,  MUSIC_MODE_BOSS_TOWER},
    {8, MUSIC_MODE_BOSS_HERMIT},
    {9,  MUSIC_MODE_BOSS_CHARIOT},
    {10, MUSIC_MODE_BOSS_MAGICIAN},
    {11, MUSIC_MODE_TUTORIAL},
    {12, MUSIC_MODE_SHOP},
    {13, MUSIC_MODE_GAME_OVER},
    {14, MUSIC_MODE_WIN},
    {15, MUSIC_MODE_PAUSED},
    {16,  MUSIC_MODE_SQUARE},
    {17,  MUSIC_MODE_DING},
    {18,  MUSIC_MODE_BOOM},
    {19,  MUSIC_MODE_BOOM_LONG},
    {20, MUSIC_MODE_TOWER_ASTEROID_BOOM},
    {21, MUSIC_MODE_LASER},
    {22, MUSIC_MODE_POWERUP},
};
