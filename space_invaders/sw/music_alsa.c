...
static const pattern_t PATTERN_BOSS_YELLOW = {
    .melody = {
        349.23f, R, 349.23f, 415.30f, 466.16f, R, 466.16f, 523.25f,
        349.23f, R, 392.00f, 415.30f, R, 466.16f, 415.30f, R,

        349.23f, R, 349.23f, 415.30f, 466.16f, R, 523.25f, 466.16f,
        349.23f, R, 392.00f, 415.30f, R, R, 349.23f, R,

        466.16f, R, 523.25f, R, 466.16f, R, 415.30f, R,
        349.23f, R, 392.00f, R, 415.30f, R, 466.16f, R,

        523.25f, R, 466.16f, 415.30f, 392.00f, R, 349.23f, R,
        349.23f, R, 392.00f, 415.30f, R, 466.16f, 349.23f, R
    },
    .bass = {
        87.31f, 87.31f, R, 87.31f, 92.50f, 92.50f, R, 92.50f,
        77.78f, 77.78f, R, 77.78f, 87.31f, 87.31f, 92.50f, R,
    ...
    .harm = {
        ...
        174.61f, R, 233.08f, R, 311.13f, R, 261.63f, R,
        174.61f, R, 261.63f, R, 233.08f, R, 311.13f, R,
